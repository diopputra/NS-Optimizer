//	=============================================================================================================================================================================================================================================
//	DONT CHANGE THIS AREA... Papa.parse
/* @license
Papa Parse
v5.4.1
...
(this, function s() {
        ...
        unparse: function (e, t) {
            ...
            if (Array.isArray(e)) {
                ...
                if ("object" == typeof e[0])
                    return h(i || Object.keys(e[0]), e, r)
            } else if ("object" == typeof e)
                return "string" == typeof e.data && (e.data = JSON.parse(e.data)), Array.isArray(e.data) && (e.fields || (e.fields = e.meta && e.meta.fields || i), e.fields || (e.fields = Array.isArray(e.data[0]) ? e.fields : "object" == typeof e.data[0] ? Object.keys(e.data[0]) : []), Array.isArray(e.data[0]) || "object" == typeof e.data[0] || (e.data = [e.data])), h(e.fields || [], e.data || [], r);
            ...
            function e() {
                if (0 !== u.length) {
                    ...
                    if (J(o.before)) {
                        ...
                        if ("object" == typeof s) {
                            if ("abort" === s.action)
                                return e = "AbortError", t = n.file, r = n.inputElem, i = s.reason, void(J(o.error) && o.error({
                                        name: e
                                    }, t, r, i));
                            if ("skip" === s.action)
                                return void h();
                    ...
                    n.instanceConfig.complete = function (e) {
                        J(a) && a(e, n.file, n.inputElem),
                        h()
                    },
                    b.parse(n.file, n.instanceConfig)
                } else
                    J(o.complete) && o.complete()
            }
            function h() {
                u.splice(0, 1),
                e()
    ...
    function h(e) {
        ...
        this.parseChunk = function (e, t) {
            ...
            if (!this._handle.paused() && !this._handle.aborted()) {
                ...
                return this._config.step || this._config.chunk || (this._completeResults.data = this._completeResults.data.concat(n.data), this._completeResults.errors = this._completeResults.errors.concat(n.errors), this._completeResults.meta = n.meta),
    ...
    function p(e) {
        ...
        this._nextChunk = function () {
            if (!this._finished) {
                ...
                return t ? (e = r.substring(0, t), r = r.substring(t)) : (e = r, r = ""),
                this._finished = !r,
                this.parseChunk(e)
            }
        }
    ...
    function r(m) {
            ...
            m.step = function (e) {
                if (c = e, _())
                    ...
                    if (g(), 0 === c.data.length)
                        return;
                    r += e.data.length,
                    m.preview && r > m.preview ? o.abort() : (c.data = c.data[0], p(c, t))
                }
            }
        }
        function y(e) {
        ...
        function g() {
            return c && u && (k("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + b.DefaultDelimiter + "'"), u = !1),
            m.skipEmptyLines && (c.data = c.data.filter(function (e) {
                    return !y(e)
                })),
            _() && function () {
                if (!c)
            ...
            function () {
                ...
                function e(e, t) {
                    ...
                    return m.header && (r > l.length ? k("FieldMismatch", "TooManyFields", "Too many fields: expected " + l.length + " fields but parsed " + r, f + t) : r < l.length && k("FieldMismatch", "TooFewFields", "Too few fields: expected " + l.length + " fields but parsed " + r, f + t)),
                    i
                }
                var t = 1;
        ...
        function v(e, t) {
            ...
            !0 === (m.dynamicTyping[r] || m.dynamicTyping) ? "true" === t || "TRUE" === t || "false" !== t && "FALSE" !== t && (function (e) {
                if (s.test(e)) {
                    var t = parseFloat(e);
                    if (n < t && t < i)
                        return !0
        ...
        this.parse = function (e, t, r) {
            ...
            if (m.newline || (m.newline = function (e, t) {
                    ...
                    for (var h = 0; h < n.length; h++) {
                        ...
                        for (var p = new E({
                            ...
                            if (r && y(p.data[g]))
                                ...
                                l += _,
                                void 0 !== o ? 0 < _ && (d += Math.abs(_ - o), o = _) : o = _
                            }
                        0 < p.data.length && (l /= p.data.length - c),
                        (void 0 === a || d <= a) && (void 0 === u || u < l) && 1.99 < l && (a = d, s = f, u = l)
                    }
                    return {
                ...
                n.successful ? m.delimiter = n.bestDelimiter : (u = !0, m.delimiter = b.DefaultDelimiter),
    ...
    function E(j) {
        ...
        this.parse = function (i, t, r) {
            ...
            if (B || !1 !== B && -1 === i.indexOf(z)) {
                for (var b = i.split(P), E = 0; E < b.length; E++) {
                    ...
                    if (!U || f.substring(0, a) !== U) {
                        if (o) {
                            if (u = [], I(f.split(M)), F(), H)
                                return L()
                        } else
                            I(f.split(M));
                        if (N && N <= E)
                            return u = u.slice(0, N), L(!0)
                    }
                }
                return L()
            }
                        ...
                        if (z !== K || i[S + 1] !== K) {
                            if (z === K || 0 === S || i[S - 1] !== K) {
                                ...
                                if (i.substring(S + 1 + x, S + 1 + x + s) === P) {
                                    if (f.push(i.substring(W, S).replace(C, z)), D(S + 1 + x + s), w = i.indexOf(M, W), S = i.indexOf(z, W), o && (F(), H))
                                        return L();
                                    if (N && u.length >= N)
                                        return L(!0);
                                    break
            ...
            function T(e) {
                return r || (void 0 === e && (e = i.substring(W)), f.push(e), W = n, I(f), o && F()),
                L()
            }
            function D(e) {
                W = e,
    ...
    function m(e, t) {
        var r = a[e];
        J(r.userComplete) && r.userComplete(t),
        r.terminate(),
        delete a[e]
    }
    function y() {
...
function CSV2JSON(data) {
    ...
    let getHdr = data.split('\n')[0]; // 				AMBIL HEADER SEBAGAI SAMPEL UJI
    log.debug(vRndN + ' ' + "SAMPLING: Data Header", getHdr);

    let maxColumns = 0;
    let selectedDelimiter = ',';

    //	Memilih secara otomatis, Delimiter apa yg digunakan dalam Dokumen
    ...
    log.debug(vRndN + ' ' + "Selected Delimiter:", selectedDelimiter);

    //	Papa.parse, mengubah CSV to JSON
    data = papa.parse(data, {
        delimiter: selectedDelimiter,
        header: true,
    }).data;

    // Membuang baris jika KEY pertama kosong, ini adalah TRAP jika CSV memiliki LastLine Enter berupa baris kosong.
    data = data.filter(obj => {
        const keys = Object.keys(obj);
        return obj[keys[0]] != "";
    });
    log.debug(vRndN + ' ' + "Check: LastLine" + data.length, data[data.length - 1]);

    // Mengubah header ke huruf kecil (lowercase)
    // Menambahkan properti csv_line_index
    let newData = data.map((obj, index) => {
        ...
        return {
            ...obj,
            stgSO_line_index: index + 1
        };
    });

    log.debug(vRndN + ' ' + "CSV Converted to JSON: " + newData.length, newData);
